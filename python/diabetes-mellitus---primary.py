...
codes = [{"code":"C10..00","system":"readv2"},{"code":"C108.12","system":"readv2"},{"code":"C108.13","system":"readv2"},{"code":"C109.12","system":"readv2"},{"code":"C109.13","system":"readv2"},{"code":"C10E.00","system":"readv2"},{"code":"C10E.11","system":"readv2"},{"code":"C10F.00","system":"readv2"},{"code":"C10F.11","system":"readv2"},{"code":"C10FS00","system":"readv2"},{"code":"C10M.00","system":"readv2"}];
REQUIRED_CODES = 1;
