...
codes = [{"code":"C104.11","system":"readv2"},{"code":"C104z00","system":"readv2"},{"code":"C108D11","system":"readv2"},{"code":"C109C11","system":"readv2"},{"code":"C109C12","system":"readv2"},{"code":"C10ED00","system":"readv2"},{"code":"C10FC00","system":"readv2"},{"code":"C10FC11","system":"readv2"}];
REQUIRED_CODES = 1;
